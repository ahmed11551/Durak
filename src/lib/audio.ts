// Web Audio API Synthesizer for rich interactive sound FX without external assets
class SoundManager {
  ...
  public playTurnAlert() {
    ...
    osc.frequency.setValueAtTime(1046.5, this.ctx.currentTime + 0.08);
